function editTools(engine, sceneObjects, position, scale, color, debug) {
    ...
    const scaleObject = () => {
        ...
        // debug.innerHTML = JSON.stringify(engine._root.children[last].geometry.parameters);
        // debug.innerHTML = JSON.stringify(engine._root.children[last].geometry.type);
